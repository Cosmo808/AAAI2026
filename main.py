...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_dir', type=str, default=r"yourpath")
    ...
    ##############################################################################
    # For AAAI 2026 Submission
    # Here are codes to set hyperparameters for each datasets
    # Will be public after accept
    ##############################################################################
